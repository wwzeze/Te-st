...
if _G.LoadingScreen ~= true then
    loadstring(game:HttpGet("https://pastebin.com/raw/vrkRXLEJ"))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
